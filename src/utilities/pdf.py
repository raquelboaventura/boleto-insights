...
from src.utilities.configs import get_logger  # Importa o logger configurado
...
def transforma_em_float(dados):
    for i, linha in enumerate(dados):
        if len(linha) > 3 and linha[3] and linha[3].strip():  # Verifica se a string não está vazia ou apenas com espaços em branco
